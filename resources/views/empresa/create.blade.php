<x-app-layout>
    ...
    <script>
        function seleccionarEmpresa(name, direccion, barrio, ciudad, telefono, id) {
        ...
        var nitInput = document.getElementById('nit_input');
        var searchInput = document.getElementById('search-dropdown');

        // Función para actualizar los campos de nombre y NIT
        function updateFields() {
            var searchTerm = searchInput.value.trim();

            // Si el término de búsqueda es un número, asumimos que es el NIT
            if (!isNaN(searchTerm)) {
                nitInput.value = searchTerm;
                nameInput.value = ''; // Limpiar el campo de Razón Social
            } else {
                // Si no es un número, lo asumimos como el nombre de la empresa
